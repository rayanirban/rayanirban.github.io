...
\begin{center}
  ...
  Final year PhD Student in Computer Science \\ Computational Image Restoration \textbar{} Generative AI for Microscopy\\
  \href{mailto:anirban.ray@fht.org}{Email}
  \textbar{} \href{https://rayanirban.github.io/}{Personal Page}
  \textbar{} \href{https://github.com/rayanirban}{GitHub}
  ...
  \textbar{} \href{https://orcid.org/0000-0002-7285-6727}{ORCID}\\
  Last updated: May 2026
\end{center}

\section*{Profile}
I am a final year PhD student in Computer Science at Technische Universit\"at Dresden and Human Technopole, Italy, advised by Dr. Florian Jug. My research develops flow-matching and other deep learning methods for inverse problems in biological microscopy, with an emphasis on computational image restoration, dehazing, super-resolution, denoising, uncertainty estimation, and posterior sampling. I am broadly interested in AI4Science.
...
\begin{itemize}
  ...
  \item Thesis (working title): \textit{Generative Image Restoration for Microscopy}.
...
\begin{itemize}
  ...
  \item Accepted to CVPR 2026 (Findings) and additionally selected as a poster for the Computer Vision for Science (CV4Science) Workshop at CVPR 2026; arXiv preprint available since June 2025.
  \item Code, data, models, and a quickstart Jupyter notebook were made available in May 2026.
...
\begin{enumerate}[label={[\arabic*]}]
  ...
  \paper{\textbf{Anirban Ray}, Ashesh, and Florian Jug}{\href{https://arxiv.org/abs/2506.22397}{HazeMatching: Conditional Flow Matching for Microscopy Dehazing}}{CVPR 2026 (Findings)}{Accepted; also selected for a CV4Science Workshop poster; arXiv preprint.}
...
\section*{Patents}
\begin{itemize}
  \item \href{https://patents.google.com/patent/US12327363B2}{US Patent 12327363B2}: \textit{Apparatus, method and system for generating models for identifying objects of interest from images}. Inventors: \textbf{Anirban Ray}, Hideharu Hattori, and Yasuki Kakishita. Assignee: Hitachi High-Tech Corporation. Filed Feb. 2, 2021; granted Jun. 10, 2025.
  \item \href{https://patents.google.com/patent/US12211213B2}{US Patent 12211213B2}: \textit{Image processing method, image processing apparatus, and image processing system}. Inventors: \textbf{Anirban Ray}, Hideharu Hattori, Yasuki Kakishita, and Taku Sakazume. Assignee: Hitachi High-Tech Corporation. Filed Feb. 6, 2020; granted Jan. 28, 2025.
  \item \href{https://patents.google.com/patent/EP3961562A1}{EP Patent 3961562A1}: \textit{Image processing method, image processing device, and image processing system}. Inventors: \textbf{Anirban Ray}, Hideharu Hattori, Yasuki Kakishita, and Taku Sakazume. Assignee: Hitachi High-Tech Corporation. Published Mar. 2, 2022; granted as EP3961562B1 on Dec. 20, 2023.
\end{itemize}

\section*{Presentations and Posters}
\begin{itemize}
  \item \textbf{Poster}: \href{https://arxiv.org/abs/2506.22397}{HazeMatching: Conditional Flow Matching for Microscopy Dehazing}. IEEE/CVF CVPR 2026 and Computer Vision for Science (CV4Science) Workshop, Denver, CO, USA, Jun. 2026.
  \item \textbf{Invited talk}: Scientific Inverse Problems in the Age of Generative AI. AI \& Advanced Computing Institute, Schmidt Sciences, New York, USA, Jun. 2026.
...
\begin{itemize}
  ...
  \item \textbf{\href{https://github.com/juglab/HazeMatching}{HazeMatching}}: Open-source implementation, data, models, and quickstart Jupyter notebook for conditional flow matching in microscopy dehazing; also demonstrated on Expansion Microscopy super-resolution through an AI4Life project.
